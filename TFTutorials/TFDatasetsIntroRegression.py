...
# Looking at your predictions can be a simple way to see how the classifier is predicting
# Here we see that we're predicting both classes but the data is probably imbalanced and is not scaled
...
# Balance the dataset with random over sampling
...
df_train = df_sample.sample(frac=1)
...
# preds_classes = model_regularized.predict_classes(X_val)
